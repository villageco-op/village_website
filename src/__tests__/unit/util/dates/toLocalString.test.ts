...
describe('UTCDateToLocal', () => {
  ...
  it('should format a date object into a YYYY-MM-DDThh:mm string', () => {
    ...
    const result = UTCDateToLocal(date);

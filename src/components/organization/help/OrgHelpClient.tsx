...
import { Loader2, Send, CheckCircle, Building } from 'lucide-react';
...
/**
 * The Organization Help & Support Page.
 * Allows organization administrators to contact support.
 * @returns A message form with a submit button
 */
export default function OrgHelpClient() {
  const { user } = useAuth();
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-forest-dark/80 max-w-lg mx-auto">
            Need help managing your organization profile, navigating the site, or need additional
            feature support? Drop us a line.
          </p>
        </div>
          ...
          {isSuccess ? (
            <CardContent className="flex flex-col items-center justify-center p-16 text-center">
              ...
              <p className="text-forest-dark/70 mb-8">
                Thank you for reaching out. We will respond to the email associated with your
                ...
                <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Describe what your organization needs help with..."

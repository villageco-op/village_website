...
import IndividualOnboardingFlow from './IndividualOnboardingFlow';
...
const meta: Meta<typeof IndividualOnboardingFlow> = {
  title: 'Onboarding/Individual/OnboardingPage',
  component: IndividualOnboardingFlow,
  parameters: {
    layout: 'fullscreen',
    nextjs: {
      appDirectory: true,
...
export default meta;
type Story = StoryObj<typeof IndividualOnboardingFlow>;
